...
func main() {
	...
	// wd, err := os.ReadFile("/databases/migrations/schema.sql")
	// if err != nil {
	// 	log.Fatalf("Failed to get working directory: %v", err)
	// }
	// log.Println("Working directory:", string(wd))
	...
	if err := executeSQLFile(db, "databases/migrations/schema.sql"); err != nil {
